...
- 🔥 Actively contributing to open-source projects in the Python, CUDA, and scientific computing ecosystems

---

## 📂 Highlighted Projects

- [BusyBeaverGPU](https://github.com/larrywigington/BusyBeaverGPU) — GPU-accelerated exploration of Busy Beaver Turing Machines
...
- (Tentative) 📣 Speaker @ International Conference on Stochastic Programming 2025 (Paris)  
  *\"Solving Stochastic Programs with GPUs: A Literature Review\"*
- (Tentative) 📋 Poster Presentation @ SIAM Northern and Central California Sectional Conference (NCC25)  
  *\"Solving Stochastic Linear Programs on GPUs\"*
- ✍️ Publishing articles on GPU optimization and computational linear algebra (see [Website](https://www.larrywigington.com))
...
- 📬 GitHub Discussions or Issues — Always happy to collaborate!

---

> \"Optimization is not just about better answers — it's about better decisions, faster, and at greater scale.\"
